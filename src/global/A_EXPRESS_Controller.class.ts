...
export class A_EXPRESS_Controller implements A_EXPRESS_TYPES__IController {
    ...
    async get(req: A_EXPRESS_TYPES__IRequest, res: Response, next: NextFunction): Promise<any> {
    ...
    async post(req: A_EXPRESS_TYPES__IRequest, res: Response, next: NextFunction): Promise<any> {
    ...
    async put(req: A_EXPRESS_TYPES__IRequest, res: Response, next: NextFunction): Promise<any> {
        return next(A_EXPRESS_Context.Errors
            .getError(A_SDK_CONSTANTS__ERROR_CODES.METHOD_NOT_IMPLEMENTED)
        );
    }
    ...
    async delete(req: A_EXPRESS_TYPES__IRequest, res: Response, next: NextFunction): Promise<any> {
        return next(A_EXPRESS_Context.Errors
            .getError(A_SDK_CONSTANTS__ERROR_CODES.METHOD_NOT_IMPLEMENTED)
        );
    }

    async list(req: A_EXPRESS_TYPES__IRequest, res: Response, next: NextFunction): Promise<any> {
        return next(A_EXPRESS_Context.Errors
            .getError(A_SDK_CONSTANTS__ERROR_CODES.METHOD_NOT_IMPLEMENTED)
        );
    }
