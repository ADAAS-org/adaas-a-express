...
export interface A_EXPRESS_TYPES__ICRUDController<
    ...
    _ContextType extends A_EXPRESS_CRUDController<_DBEntityType, _RequestType> = any,
>
    extends A_EXPRESS_TYPES__IController {
...
export interface A_EXPRESS_TYPES__IARCRequestParam<
...
export interface A_EXPRESS_TYPES__ICRUDControllerRepository<
    T,
> {
     ...
     * 
     */
    getPage(props: A_EXPRESS_TYPES__IGetPageOptions & { [key: string]: any }): Promise<A_SDK_TYPES__IDefaultPagination<T>>
}
...
export type A_EXPRESS_TYPES__Controller_ListConfig<
    _DBEntityType extends A_SDK_TYPES__Dictionary<any> = any,
    _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest,
    _ContextType extends A_EXPRESS_CRUDController<_DBEntityType, _RequestType> = A_EXPRESS_CRUDController<_DBEntityType, _RequestType>,
    _WhereType = any
> = {
...
export type A_EXPRESS_TYPES__Controller_GetConfig<
    _DBEntityType extends A_SDK_TYPES__Dictionary<any> = any,
    _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest,
    _ContextType extends A_EXPRESS_CRUDController<_DBEntityType, _RequestType> = A_EXPRESS_CRUDController<_DBEntityType, _RequestType>,
    _WhereType = any
...
export type A_EXPRESS_TYPES__Controller_PutConfig<
    _DBEntityType extends A_SDK_TYPES__Dictionary<any> = any,
    _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest,
    _ContextType extends A_EXPRESS_CRUDController<_DBEntityType, _RequestType> = A_EXPRESS_CRUDController<_DBEntityType, _RequestType>,
    _WhereType = any
...
export type A_EXPRESS_TYPES__Controller_DeleteConfig<
    _DBEntityType extends A_SDK_TYPES__Dictionary<any> = any,
    _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest,
    _ContextType extends A_EXPRESS_CRUDController<_DBEntityType, _RequestType> = A_EXPRESS_CRUDController<_DBEntityType, _RequestType>,
    _WhereType = any
