...
export interface A_EXPRESS_TYPES__IControllerRepository<
    T,
> {
     ...
     * 
     */
    getPage(props: A_EXPRESS_TYPES__GetPageOptions<T> & { [key: string]: any }): Promise<A_SDK_TYPES__IDefaultPagination<T>>
}

export type A_EXPRESS_TYPES__EntityController_ListConfig<
    _DBEntityType = any,
    _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest,
    _ContextType = any,
    _WhereType = any
...
export type A_EXPRESS_TYPES__EntityController_GetConfig<
    _DBEntityType = any,
    _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest,
    _ContextType = any,
    _WhereType = any
...
export type A_EXPRESS_TYPES__EntityController_PostConfig<
    _DBEntityType = any,
    _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest,
    _ContextType = any,
> = {
...
export type A_EXPRESS_TYPES__EntityController_PutConfig<
    _DBEntityType = any,
    _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest,
    _ContextType = any,
    _WhereType = any
...
export type A_EXPRESS_TYPES__EntityController_DeleteConfig<
    _DBEntityType = any,
    _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest,
    _ContextType = any,
    _WhereType = any
...
export interface A_EXPRESS_TYPES__EntityControllerConfig<
    _DBEntityType = any,
    _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest,
    _ContextType = any
> extends A_EXPRESS_TYPES__ControllerConfig {
