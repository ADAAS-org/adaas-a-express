...
exports.A_EXPRESS_BaseController = void 0;
 ...
 *
 */
let A_EXPRESS_BaseController = class A_EXPRESS_BaseController {
    ...
    list(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const listConfig = a_sdk_types_1.A_SDK_CommonHelper.deepMerge(Object.assign({}, A_EXPRESS_DEFAULTS__ENTITY_CONTROLLER_CONFIG.list), this.config.list);
    ...
    post(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const postConfig = a_sdk_types_1.A_SDK_CommonHelper.deepMerge(Object.assign({}, A_EXPRESS_DEFAULTS__ENTITY_CONTROLLER_CONFIG.post), this.config.post);
    ...
    put(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!this.repository)
                    return this.context.Errors.throw(errors_constants_1.A_EXPRESS_CONSTANTS__ERROR_CODES.OVERRIDE_METHOD_OR_PROVIDE_REPOSITORY);
                const putConfig = a_sdk_types_1.A_SDK_CommonHelper.deepMerge(Object.assign({}, A_EXPRESS_DEFAULTS__ENTITY_CONTROLLER_CONFIG.put), this.config.put);
    ...
    get(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!this.repository)
                    return this.context.Errors.throw(errors_constants_1.A_EXPRESS_CONSTANTS__ERROR_CODES.OVERRIDE_METHOD_OR_PROVIDE_REPOSITORY);
                const getConfig = a_sdk_types_1.A_SDK_CommonHelper.deepMerge(Object.assign({}, A_EXPRESS_DEFAULTS__ENTITY_CONTROLLER_CONFIG.get), this.config.get);
    ...
    delete(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!this.repository)
                    return this.context.Errors.throw(errors_constants_1.A_EXPRESS_CONSTANTS__ERROR_CODES.OVERRIDE_METHOD_OR_PROVIDE_REPOSITORY);
                const deleteConfig = a_sdk_types_1.A_SDK_CommonHelper.deepMerge(Object.assign({}, A_EXPRESS_DEFAULTS__ENTITY_CONTROLLER_CONFIG.delete), this.config.delete);
...
exports.A_EXPRESS_BaseController = A_EXPRESS_BaseController;
__decorate([
     ...
     */
], A_EXPRESS_BaseController.prototype, "list", null);
__decorate([
     ...
     */
], A_EXPRESS_BaseController.prototype, "post", null);
__decorate([
     ...
     */
], A_EXPRESS_BaseController.prototype, "put", null);
__decorate([
    (0, Methods_decorator_1.A_EXPRESS_Get)(),
    (0, Access_decorator_1.A_EXPRESS_Access)({
        acl: {
     ...
     * Defines a Default GET method for the controller. Basically it's an endpoint for getting existing entities
     */
], A_EXPRESS_BaseController.prototype, "get", null);
__decorate([
     ...
     */
], A_EXPRESS_BaseController.prototype, "delete", null);
exports.A_EXPRESS_BaseController = A_EXPRESS_BaseController = __decorate([
