...
export declare class A_EXPRESS_ErrorsMiddleware {
    static handleError(error: A_SDK_ServerError, req: A_EXPRESS_TYPES__IRequest, res: A_EXPRESS_TYPES__IResponse, next: A_EXPRESS_TYPES__INextFunction): Promise<A_EXPRESS_TYPES__IResponse<any>>;
}
