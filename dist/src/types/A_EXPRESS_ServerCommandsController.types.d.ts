...
export interface A_EXPRESS_TYPES__SERVER_COMMANDS_ControllerConfig<_DBEntityType extends A_SDK_TYPES__Dictionary<any>> extends A_EXPRESS_TYPES__ICRUDControllerConfig<_DBEntityType, A_EXPRESS_TYPES__SERVER_COMMANDS_IRequest> {
}
