...
export interface A_EXPRESS_TYPES__SERVER_COMMANDS_IRequest<_ReqBodyType = any, _AccessKeys extends Array<string> = ['default'], _ResourcesKeys extends Array<string> = ['default'], T extends A_EXPRESS_TYPES__SERVER_COMMANDS_IRequestQueryParams = A_EXPRESS_TYPES__SERVER_COMMANDS_IRequestQueryParams, P extends A_EXPRESS_TYPES__SERVER_COMMANDS_IRequestParams = A_EXPRESS_TYPES__SERVER_COMMANDS_IRequestParams> extends A_EXPRESS_TYPES__IRequest<_ReqBodyType, T, P, _AccessKeys, _ResourcesKeys> {
    params: P;
    query: T;
    adaas: {
        /**
