...
export type A_EXPRESS_TYPES__APP_INTERACTIONS_IRequestQueryParams = {} & A_EXPRESS_TYPES__IRequestQueryParams;
export type A_EXPRESS_TYPES__APP_INTERACTIONS_IRequestParams<T extends string[] = ['aseid', 'id']> = {} & A_EXPRESS_TYPES__IRequestParams<T>;
