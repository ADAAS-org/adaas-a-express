...
export declare function A_EXPRESS_Resources<_ContextType = any, _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest, _ResourcesKeys extends Array<string> = ['default']>(params: {
