...
export declare function A_EXPRESS_Access<_ContextType = A_EXPRESS_Controller, _RequestType extends A_EXPRESS_TYPES__IRequest = A_EXPRESS_TYPES__IRequest, _AccessKeys extends Array<string> = ['default']>(params: {
    acl?: {
